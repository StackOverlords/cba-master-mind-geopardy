...
export default function InfoToast({ t, title, description }: Props) {
    return (
        <AnimatePresence>
            <motion.div
                key={t.id}
            ...
            >
                ...
                <div className='absolute -top-10 -right-10 bg-linear-to-bl from-blue-400 to-transparent w-2/3 h-32 rounded-full mask-l-from-30% mask-b-from-70%' />
                <HelpIcon className="w-8 h-8 text-blue-300 ml-4 mr-8" />
