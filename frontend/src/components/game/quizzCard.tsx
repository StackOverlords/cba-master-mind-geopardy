...
const QuizzCard: React.FC<Props> = ({
    ...
    return (
        <>
            <article
                className={`relative h-18 md:h-24 w-full cursor-pointer transition-all duration-300 border-indigo-400/50 bg-indigo-900/60 border rounded-lg hover:bg-indigo-800/80 ${used ? "bg-indigo-950/30 border-indigo-700/20" : ""}`}
            >
