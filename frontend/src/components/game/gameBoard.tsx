...
const createCards = () => {
  const iconConfigs = [
    { icon: LaptopIcon, color: "text-rose-400" },
    { icon: LaptopIcon, color: "text-amber-400" },
    { icon: LaptopIcon, color: "text-yellow-400" },
    { icon: LaptopIcon, color: "text-purple-400" },
    { icon: LaptopIcon, color: "text-sky-400" },
    { icon: LaptopIcon, color: "text-emerald-400" }
  ]
