  ...
  return (
    <div className="min-h-screen relative overflow-hidden backdrop-blur-sm">
      ...
      <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16"> 
        ...
        >
          <h1 className="text-4xl sm:text-5xl md:text-6xl font-extrabold font-poppins text-white mb-3 sm:mb-4 bg-gradient-to-r from-blue-400 via-purple-500 to-pink-500 bg-clip-text text-transparent leading-tight"> 
            Master Mind CBA
          </h1>
        ...
        >
          <div className="bg-white/5 backdrop-blur-md rounded-2xl p-5 sm:p-7 border border-white/10 shadow-lg shadow-white/5"> 
            <h2 className="text-2xl sm:text-3xl font-bold font-poppins text-white mb-5 sm:mb-6 text-center bg-gradient-to-r from-teal-400 to-cyan-500 bg-clip-text text-transparent">About the Project</h2> 
        ...
        <motion.div
          ...
          className="mb-12 sm:mb-16" // Reducido mb
        >
          <h2 className="text-2xl sm:text-3xl font-bold font-poppins text-white mb-7 sm:mb-9 text-center bg-gradient-to-r from-pink-400 to-red-500 bg-clip-text text-transparent">Project Creators</h2> {/* Ajuste de tamaño de texto y mb */}
        ...
        <motion.div
          ...
          className="mb-12 sm:mb-16" // Reducido mb
        >
          <h2 className="text-2xl sm:text-3xl font-bold font-poppins text-white mb-7 sm:mb-9 text-center bg-gradient-to-r from-green-400 to-blue-500 bg-clip-text text-transparent">Development Team</h2> {/* Ajuste de tamaño de texto y mb */}
          <p className="text-base sm:text-lg text-gray-300 text-center mb-7 sm:mb-9 max-w-2xl mx-auto font-light px-2 sm:px-0"> 
                ...
                >
                  <div className="flex flex-col sm:flex-row items-center sm:items-start gap-4 text-center sm:text-left">
                    ...
                    <div className="flex-1 min-w-0"> 
                      ...
                      <p className="text-sm sm:text-base text-green-300 font-medium mb-2"> 
                        {dev.role}
                      </p>
                      <p className="text-xs sm:text-sm text-gray-300 leading-relaxed mb-3 sm:mb-4"> 
        ...
        >
          <div className="bg-white/5 backdrop-blur-md rounded-2xl p-5 sm:p-7 border border-white/10 shadow-lg shadow-white/5"> 
            <div className="flex flex-col sm:flex-row items-center justify-center mb-2 sm:mb-3 text-gray-400 gap-1.5 sm:gap-2"> {/* Reducido mb y gap */}
              <Lightbulb className="w-4 h-4 sm:w-5 h-5 mr-0 sm:mr-1.5 text-yellow-400" /> 
